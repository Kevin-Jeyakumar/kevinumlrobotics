...
class Angle_PID(PID):
    ...
    def callback(self,data):
        ...
        vel = self.vel
        rospy.set_param("mypub_phi","False")
        if inp!=0:
            rospy.set_param("mypub_phi","True")
        #if rospy.get_param("mypub_d") == "True":
        #    return
        om = inp
...
if __name__ == '__main__':
    try:
        ...
        timing = rospy.get_rostime()
        Angle_PID(1, 0, 0, (timing.secs+(timing.nsecs/1000000000)), 0.1, 0.6)
